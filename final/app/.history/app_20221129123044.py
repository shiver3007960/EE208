...
def images():
    ...
    if query is None:
        return render_template('images.html', lenPicPool = 2, picPool = None, lenpagechangetable=20//5, lensearchHistory = min(5, len(record.picdata.keys())), searchH = list(record.picdata.keys()))
